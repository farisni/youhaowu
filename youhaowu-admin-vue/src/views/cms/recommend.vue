  ...
  <div class="cms-page">
      ...
      <template #search>
        <el-form :inline="true">
          <el-form-item label="标题">
            <el-input v-model="searchObj.title" placeholder="推荐标题" @keyup.enter="handleSearch" />
          </el-form-item>
    ...
    <el-dialog v-model="dialogVisible" @keyup.enter="submitForm" :title="dialogTitle" width="500px" :close-on-click-modal="false">
      <el-form :model="form" label-width="100px">
        <el-form-item label="标题">
          <el-input v-model="form.title" placeholder="推荐标题" />
        </el-form-item>
        ...
        <el-form-item label="跳转链接">
          ...
          <span style="font-size:12px;color:#999">用户点击推荐图后跳转的目标地址（商品页、活动页等）</span>
        </el-form-item>
...
import api from '@/api/cms/recommendApi.js'
...
const remove = (row) => {
  ElMessageBox.confirm(`确定删除推荐【${row.title}】？`, '提示', {

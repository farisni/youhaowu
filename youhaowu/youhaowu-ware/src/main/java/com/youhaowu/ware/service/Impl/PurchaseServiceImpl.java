...
import com.youhaowu.ware.entity.PurchaseEntity;
import com.youhaowu.ware.mapper.PurchaseMapper;
...
import com.youhaowu.ware.vo.PurchaseItemDoneVo;
...
public class PurchaseServiceImpl implements PurchaseService {
    ...
    public void done(PurchaseDoneVo doneVo) {
        ...
        if (doneVo.getItems() != null) {
            for (com.youhaowu.ware.vo.PurchaseItemDoneVo item : doneVo.getItems()) {
                PurchaseDetailEntity detail = new PurchaseDetailEntity();

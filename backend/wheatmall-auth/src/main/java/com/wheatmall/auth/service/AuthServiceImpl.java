...
import com.wheatmall.auth.entity.SysUser;
import com.wheatmall.auth.mock.MockData;
import com.wheatmall.auth.security.jwt.JwtUtil;
import com.wheatmall.auth.security.service.SecurityUser;
...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse refreshToken(String refreshToken) {
        ...
        if (!jwtUtil.validateToken(refreshToken)) {
            throw new com.wheatmall.auth.exception.TokenInvalidException("Token无效");
        }
        ...
        if (user == null) {
            throw new com.wheatmall.auth.exception.TokenInvalidException("用户不存在");
        }

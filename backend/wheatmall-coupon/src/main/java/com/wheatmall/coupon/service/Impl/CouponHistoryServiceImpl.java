...
import com.wheatmall.coupon.entity.CouponHistoryEntity;
import com.wheatmall.coupon.mapper.CouponHistoryMapper;
...
public class CouponHistoryServiceImpl implements CouponHistoryService {
    ...
    public Integer removeByIds(List<Long> ids) {
        return couponHistoryMapper.deleteBatchIds(ids);
    }

...
**youhaowu-auth-admin** 是 有好物 商城系统的认证授权管理模块，提供统一的用户认证、权限管理和安全控制功能。
...
```bash
cd backend/youhaowu-auth-admin
mvn spring-boot:run
```
...
```xml
<dependency>
    <groupId>com.youhaowu.common</groupId>
    <artifactId>youhaowu-common</artifactId>

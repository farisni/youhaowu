...
public class RankController {
    ...
    public R<List<RankVO>> list(@RequestParam String tab) {
        return R.ok(rankService.listByTab(tab));
    }
    ...
    public R<RankVO> info(@PathVariable Long id) {
    ...
    public R<PageData<RankVO>> page(@RequestBody RankQueryDTO query) {
        return R.ok(rankService.page(query));
    }
    ...
    public R<Integer> save(@RequestBody RankSaveDTO dto) {
        return R.ok(rankService.save(dto));
    }
    ...
    public R<Integer> deleteBatch(@RequestBody List<Long> ids) {
        return R.ok(rankService.deleteBatch(ids));
    }
}
